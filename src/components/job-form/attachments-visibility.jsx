  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div
          className={`border-2 border-dashed rounded-md p-6 text-center ${dragActive ? "border-[#12a1e2] bg-[#12a1e2]/5" : "border-slate-200 bg-white"
            }`}
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-slate-600 mb-1">Drag and drop files here, or</p>
            <button
              type="button"
              onClick={() => fileInputRef.current.click()}
              className="text-[#12a1e2] hover:text-[#0e8cd4] font-medium"
            >
              Browse files
            </button>
      ...
      {jobData.attachments.length > 0 && (
        <div className="space-y-2">
          <div className="text-sm font-medium text-slate-700 mb-2">Uploaded Files</div>
          <div className="space-y-2">
            {jobData.attachments.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between bg-white border border-slate-200 rounded-md p-3 shadow-sm"
              >
