              ...
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-[#1e1e2d] p-4 rounded-lg">
                    ...
                    <p className="text-xl font-bold mt-1">$ {profileData?.totalSpent?.toLocaleString() || "0"}</p>
                  </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold">$ {profileData?.payments?.inProgress?.toLocaleString() || "0"}</span>
                  </div>
