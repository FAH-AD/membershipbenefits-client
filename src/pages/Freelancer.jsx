...
const Freelancer = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="flex flex-col items-center">
          <div className="w-16 h-16 border-4 bg-[#12a1e2] border-t-transparent rounded-full animate-spin"></div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-12">
      <Navbar />
      {/* Welcome Header */}
      <div className="bg-gradient-to-r from-[#12a1e2]/20 to-slate-50 border-slate-200">
            ...
            <div className="bg-white rounded-lg border border-slate-200">
              <div className="p-6 border-b border-[#2d2d3a]">
                ...
                <div className="flex mt-4 border-b border-[#2d2d3a]">
                  ...
                  {/* <button
                   className={`px-4 py-2 text-sm font-medium ${activeTab === "saved" ? "text-[#12a1e2] border-b-2 bg-[#12a1e2]" : "text-slate-500 hover:text-white"}`}
              ...
              <div className="p-4">
                {isJobsLoading ? (
                  <div className="flex justify-center items-center h-40">
                    <div className="animate-spin rounded-full h-10 w-10 border-b-2 bg-[#12a1e2]"></div>
                  </div>
                  ...
                  <div className="text-center py-8">
                    <p className="text-slate-500">No jobs found matching your skills.</p>
                  </div>
                )}
              </div>
              ...
              <div className="p-4">
                <div className="space-y-4">
                  {activeProjects.slice(0, 2).map((project) => (
                    <div key={`deadline-${project.id}`} className="flex items-center p-3 bg-slate-100 rounded-lg">
                      <div className="bg-slate-100 p-2 rounded-lg mr-4">
                        <Calendar size={20} className="text-[#12a1e2]" />
                      </div>
                      <div className="flex-1">
                        <h4 className="font-medium text-sm">{project.title}</h4>
                        <p className="text-slate-500 text-xs">Due {project.deadline}</p>
                      </div>
                      <div
                ...
                <a
                  ...
                  className="block text-center text-[#12a1e2] hover:text-[#12a1e2] text-sm mt-4"
                >
                  View All Deadlines
                </a>
              </div>
