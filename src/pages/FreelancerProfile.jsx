...
const FreelancerProfile = () => {
    ...
    const fetchProfileData = async () => {
        ...
        try {
            const endpoint = userId
                ? ` https://membershiptbenefits-server-1.onrender.com/api/user-profile/${userId}`
                : " https://membershiptbenefits-server-1.onrender.com/api/user-profile/profile"
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(` https://membershiptbenefits-server-1.onrender.com/api/user-profile/${userId}`, {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("authToken")}`,
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-[#1e1e2d] p-4 rounded-lg">
                                    ...
                                    <p className="text-xl font-bold mt-1">$ {profileData?.totalEarnings?.toLocaleString() || "0"}</p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="font-bold">
                                            $ {profileData?.payments?.inProgress?.toLocaleString() || "0"}
                                        </span>
                                    </div>

                                    <div className="flex items-center justify-between">
                                        <span className="text-gray-300">Pending</span>
                                        <span className="font-bold">$ {profileData?.payments?.pending?.toLocaleString() || "0"}</span>
                                    </div>

                                    <div className="flex items-center justify-between">
                                        <span className="text-gray-300">Available</span>
                                        <span className="font-bold">$ {profileData?.payments?.available?.toLocaleString() || "0"}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
