  ...
  const handleSubmitMilestone = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ` https://membershiptbenefits-server-1.onrender.com/api/freelancer/jobs/${selectedTeam._id}/milestones/${submittingMilestone._id}/submit`,
        submissionData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="bg-[#1e1e2d] p-4 rounded-lg">
                        ...
                        <p className="text-lg font-bold">$ {selectedTeam.freelancerDetails.totalEarnings.toLocaleString()}</p>
                      </div>
                      <div className="bg-[#1e1e2d] p-4 rounded-lg">
                        <h3 className="text-sm font-medium text-gray-400 mb-1">In Progress</h3>
                        <p className="text-lg font-bold">$ {selectedTeam.freelancerDetails.workInProgress.toLocaleString()}</p>
                      </div>
                      <div className="bg-[#1e1e2d] p-4 rounded-lg">
