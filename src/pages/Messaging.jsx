  ...
  const deleteConversation = async (conversationId) => {
    ...
    try {
      ...
      if (selectedConversation && selectedConversation._id === conversationId) {
        ...
        setMessages([]);
        navigate("/company-member/messages", { replace: true });
      }
    } catch (err) {
    ...
    <div className=" bg-white text-white">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex-1 flex h-[100%] overflow-hidden">
                ...
                filteredConversations?.map((conversation) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center p-4 border-b border-[#2d2d3a] cursor-pointer hover:bg-[#1e1e2d] transition-colors ${selectedConversation &&
          ...
          {selectedConversation ? (
            <div
              className={`flex-1 flex flex-col overflowX-auto maxW-[400px] h-[80vh] ${!selectedConversation && window.innerWidth < 768 ? "hidden" : ""
                }`}
            >
              {/* Chat Header */}
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                      <div className="bg-[#1e1e2d] p-6 rounded-lg w-96">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-white border border-[#2d2d3a] rounded-md text-white focus:outline-none focus:ring-2 focus:ring-[#9333EA] focus:border-transparent mb-4"
                        />
                        {isCreatingMeeting ? (
                          ...
                          <>
                            <button
                              ...
                              className={`w-full py-2 rounded-md ${!zoomTopic.trim()
                    ...
                    {messages?.map((message, index) => {
                      ...
                      return (
                        <div key={message._id || `temp-${index}`}>
                          ...
                          >
                            <div
                              className={`flex max-w-[75%] ${isUserMessage ? "flex-row-reverse" : ""
                                }`}
                            >
                              {!isUserMessage && (
                                          ...
                                          (attachment, idx) => {
                                            ...
                                            if (isImage) {
                                              ...
                                              return (
                                                <div
                                                  key={idx}
                                                  className="bg-white/50 rounded-lg p-3 flex items-center"
                                                >
              ...
              <div className="p-4 border-t border-[#2d2d3a]">
                <div className="flex items-end gap-2">
                  ...
                  <button
                    ...
                    className={`p-3 rounded-full ${!newMessage.trim() || isSending
            ...
            <div className="w-80 border-l border-[#2d2d3a] flex flex-col">
              ...
              <div className="p-4 flex flex-col items-center border-b border-[#2d2d3a]">
                ...
                <div className="flex items-center mt-2">
                  <div
                    className={`h-2 w-2 rounded-full ${getOtherParticipant(selectedConversation)?.isOnline
                      ? "bg-green-500"
                      : "bg-gray-500"
                      } mr-2`}
                  ></div>
