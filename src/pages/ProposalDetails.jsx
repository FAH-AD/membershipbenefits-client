                ...
                {userBid ? (
                  <div className="flex flex-col items-end">
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      You bid $ {userBid.budget.toLocaleString()} on {formatDate(userBid.createdAt)}
                    </p>
                  </div>
                ) : (
                  <button
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="bg-[#1e1e2d] p-4 rounded-lg">
                      ...
                      <p className="text-xl font-bold">$ {userBid.budget.toLocaleString()}</p>
                    </div>
                    <div className="bg-[#1e1e2d] p-4 rounded-lg">
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span>{clientProfile.totalSpent} $</span>
                  </div>
