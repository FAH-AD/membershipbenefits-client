        ...
        >
          <motion.div variants={itemVariants} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">I'm a Company-Member</h3>
              <p className="text-gray-400">I want to hire members and post jobs</p>
            </Link>
          </motion.div>
          ...
          <motion.div variants={itemVariants} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">I'm a Member</h3>
