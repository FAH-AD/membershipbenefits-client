          ...
          <form onSubmit={handleSubmit} className="p-6">
            <div className="mb-4">
              ...
              <div className="flex space-x-4">
                <motion.button
                  ...
                  className={`flex-1 py-2 px-4 rounded-md transition-colors ${method === 'document'
                ...
                <motion.button
                  ...
                  className={`flex-1 py-2 px-4 rounded-md transition-colors ${method === 'companyEmail'
                      ? 'bg-[#9333EA] text-white'
                      : 'bg-[#1e1e2d] text-gray-300 hover:bg-[#2d2d3a]'
                    }`}
                >
            ...
            {method === 'companyEmail' && !success && (
              <motion.button
                ...
                disabled={loading}
                className={`w-full bg-[#9333EA] text-white py-2 px-4 rounded-lg hover:bg-[#a855f7] transition-colors ${loading ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
              >
