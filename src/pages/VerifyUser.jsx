        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-3 py-1 rounded-md ${currentPage === 1 ? 'bg-[#2d2d3a] text-gray-500' : 'bg-[#1e1e2d] text-white hover:bg-[#2d2d3a]'
                }`}
            >
              <ArrowLeft size={18} />
            </button>
            ...
            <button
              ...
              className={`px-3 py-1 rounded-md ${currentPage === totalPages ? 'bg-[#2d2d3a] text-gray-500' : 'bg-[#1e1e2d] text-white hover:bg-[#2d2d3a]'
                }`}
            >
              <ArrowRight size={18} />
            </button>
